...
　　var Moghunter = Moghunter || {}; 
	...
	Moghunter.btrEffectsFlash = eval(Moghunter.parameters['遇敌闪烁'] || false);
...
//进入地图判断$gameSystem._treType是否存在 不存在这创建
var Star_MapSetup_MOGBattleTransitions = Game_Map.prototype.setup;
Game_Map.prototype.setup = function(mapId) {
Star_MapSetup_MOGBattleTransitions.call(this, mapId);
if(!$gameSystem._treType){
    $gameSystem._treSpriteData = null;
	$gameSystem._treType = [0,Moghunter.btrEffectsDefault];	
	$gameSystem.trefctClear();
	$gameSystem._treCP = false;
}
};
...
// 遇怪闪烁
var _mog_trefct_scmap_startFlashForEncounter = Scene_Map.prototype.startFlashForEncounter;
Scene_Map.prototype.startFlashForEncounter = function(duration) {
	if(Moghunter.btrEffectsFlash){
		_mog_trefct_scmap_startFlashForEncounter.call(this, duration);
	}
};