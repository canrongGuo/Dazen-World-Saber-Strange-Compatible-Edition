...
Sprite_Projectile.prototype.applyAngle=function(t,e,a,r){
	/*console.log('Sprite_Projectile.prototype.applyAngle:')
	console.log('t:'+t)
	console.log('e:'+e)
	console.log('a:'+a)
	console.log('r:'+r)*/
	if(this._angled){
		...
		this.rotation=o+this._radianAdjustment-0.8203048;//-47度
