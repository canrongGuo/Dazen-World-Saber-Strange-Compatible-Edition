 ...
 * @type variable
 * @desc The Variable for gacha.
 * @default 300
 *
 * @param Required Amount
 * @desc The Required Amount for gacha.
 * @default 100
 *
...
(function () {
    ...
    var variableID = Number(parameters['Required Variable'] || '300');
    ...
    function Window_GoldGacha() {
        this.initialize.apply(this, arguments);
    }

    Window_GoldGacha.prototype = Object.create(Window_Gold.prototype);
    Window_GoldGacha.prototype.constructor = Window_GoldGacha;

    Window_GoldGacha.prototype.value = function() {
        return $gameVariables.value(variableID);
    };
    
    Window_GoldGacha.prototype.currencyUnit = function() {
        return "";// 自定义名称
    };

    Window_GoldGacha.prototype.drawCurrencyValue = function(value, unit, x, y, width) {
    ...
    Scene_Gacha.prototype.createGoldWindow = function () {
        this._goldWindow = new Window_GoldGacha(0, this._helpWindow.height);
    ...
    Scene_Gacha.prototype.commandGacha = function () {
        ...
        if (this._lot.length <= 0) {
            ...
            $gameVariables.setValue(variableID, $gameVariables.value(variableID) - amount);
    ...
    Window_GachaCommand.prototype.makeCommandList = function () {
        ...
        this.addCommand(buttonText, 'gacha', $gameVariables.value(variableID) >= amount && !!this._lotIsValid);
