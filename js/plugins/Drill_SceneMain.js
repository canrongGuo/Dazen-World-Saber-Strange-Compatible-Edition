...
Drill_SMa_ActorSprite.prototype.drill_drawName = function() {
    ...
    for ( var w=0; w< $gameParty.members().length; w++) {
		if(this._drill_actor.actor().id==$gameParty.members()[w]._actorId){
			var text = $gameParty.members()[w]._name;
			break;
		}
	}
	
	//var text = this._drill_actor.actor().name;//这里修改改名后的名字
