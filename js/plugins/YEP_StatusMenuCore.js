...
Yanfly.Param.StatusAttr_bjb = String(Yanfly.Parameters['bjb Name']);
...
Window_StatusInfo.prototype.drawElementData = function(eleId, dx, dy, dw) {
    ...
    var text = 100-(eleRate * 100).toFixed(Yanfly.Param.StatusEleDec) + '%';
    this.drawText(text, dx, dy, dw, 'right');
};
...
Window_StatusInfo.prototype.drawAttributeData = function(attr, dx, dy, dw) {
    ...
    case 'eva':
      ...
      break;
    case 'bjb':
      this.drawAttributeName(Yanfly.Param.StatusAttr_bjb, dx, dy, dw);
      var bjbl=actor.criticalMultiplierBonus()+1.5+actor.luk*0.001;
      this.drawAttributeRate(bjbl, dx, dy, dw);
      break;
    case 'cri':
    ...
    case 'pdr':
      ...
      var pdrr=1-actor.pdr;
      this.drawAttributeRate(pdrr, dx, dy, dw);
      break;
    case 'mdr':
      this.drawAttributeName(Yanfly.Param.StatusAttr_mdr, dx, dy, dw);
      var mdrr=1-actor.mdr;
      this.drawAttributeRate(mdrr, dx, dy, dw);
      break;
    case 'fdr':
      this.drawAttributeName(Yanfly.Param.StatusAttr_fdr, dx, dy, dw);
      var fdrr=1-actor.fdr;
      this.drawAttributeRate(fdrr, dx, dy, dw);
      break;
    case 'exr':
