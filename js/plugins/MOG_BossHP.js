...
/*:
 * @plugindesc (v2.3)[v1.2]  敌人 - boss生命固定框
...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_BossHP');
	...
	Moghunter.boss_list_length = 350;
	Moghunter.boss_list = {};
...
Game_Action.prototype.apply = function(target) {
	 ...
	 if (target.isEnemy() && target._bosshp_meter) {
	     ...
	     if (old_hp > target.hp) {$gameTemp._battler_bhp_temp[3] = 80};
	 };
};
...
Sprite_Base.prototype.initialize = function() {
   ...
   if (!!$gameSystem && $gameSystem._chronoBossMapID != $gameMap._mapId) {; 
       $gameSystem._chronoBossEnemy = null;
	   $gameSystem._chronoBossMapID = $gameMap._mapId;
   };   
};
